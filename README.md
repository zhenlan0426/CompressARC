...
**Amortization approach**: Each task has its own z, and weights f. An alternative is to have a shared f but different z for each task. The training would be done via stochastic gradient descent iterating over all tasks.
